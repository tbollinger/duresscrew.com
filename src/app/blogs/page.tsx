        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="flex mx-auto max-w-2xl lg:mx-0">
            <div className={``}>
              ...
              <h2 className="mt-2 text-4xl font-bold tracking-tight text-chartreuse-yellow sm:text-6xl font-medevial">Duress Crew Blog</h2>
              {/*<p className="mt-6 text-lg leading-8 text-mustard font-medevial">
      ...
      <div className="bg-white mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-5xl border-b-2 border-gray-200">
          <div className="py-16 space-y-16">
            <h2 className="text-left text-3xl font-extrabold  sm:text-4xl md:text-6xl pl-10">
              Latest Posts
            </h2>
          </div>
        </div>
                    ...
                    <div className="space-y-2 xl:grid xl:grid-cols-4 xl:items-baseline xl:space-y-0">
                      ...
                      <div className="space-y-5 xl:col-span-3">
                        <div className="space-y-6">
                          <div>
                            <h2 className="text-2xl font-bold leading-8 tracking-tight">
                              <Link key={post.id} href={`/blogs/${post.slug}`} className=" hover:text-mustard-800">{post.title}</Link>
                            </h2>
                        ...
                        <div className="text-base font-medium leading-6">
                          <Link
                            className="mr-3 text-sm font-medium uppercase text-chartreuse-yellow-600 cursor-default"
